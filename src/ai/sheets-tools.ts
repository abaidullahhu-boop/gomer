 ...
 *
 * These write Gaspo's OWN reporting data (verified ROAS, campaign performance,
...
const EXPORT_TO_SHEET_TOOL: ToolSpec = {
  ...
  description:
    "Export one of Gaspo's reporting datasets to a Google Sheet NOW, with a fixed column " +
