...
const REMEMBER_FACT_TOOL: Anthropic.Beta.BetaToolUnion = {
  type: 'custom',
...
const RECALL_FACTS_TOOL: Anthropic.Beta.BetaToolUnion = {
  type: 'custom',
...
const FORGET_FACT_TOOL: Anthropic.Beta.BetaToolUnion = {
  type: 'custom',
